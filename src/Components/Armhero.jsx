    ...
    <div className="relative h-[80vh] px-4 sm:px-6 md:px-8 lg:px-12 w-full overflow-hidden">
      ...
      <div className="mx-auto max-w-[1100px]">
        <div className="max-w-[720px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <p className="text-sm font-normal text-center max-w-[300px] md:w-full md:text-lg md:max-w-[773px] text-white leading-relaxed">
            Built for battlefield dominance and VIP protection. Mission-ready,
            field-tested, and engineered to lead from the front.
          </p>
