      ...
      <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row justify-between items-center md:space-x-14 space-y-8 md:space-y-0">
        ...
        <div className="w-full md:w-1/2" ref={rightRef}>
          ...
          <p className="text-base text-justify md:text-lg font-normal">
            ...
            as a trusted partner for military and security agencies,
            manufacturing and supplying an extensive portfolio that includes
            armoured vehicles, ballistic protection systems, tactical gear,
            defence software and technologies, and surveillance equipment.
          </p>
        </div>
      </div>
    </div>
