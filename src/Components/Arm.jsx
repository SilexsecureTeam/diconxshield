...
const Arm = () => {
  return (
    <div className="bg-[#1C3729] w-full text-center py-10 px-4 md:px-8 lg:px-12 flex justify-center items-center">
      <div className="">
        <h2 className="font-semibold text-2xl text-white text-center mb-6 md:text-4xl lg:text-5xl">
          Let’s Arm the Future, Together.
        </h2>
        <p className="md:text-[18px] text-[14px] max-w-[655px] mb-6 mx-auto font-normal text-[#D7D7D7] text-center">
